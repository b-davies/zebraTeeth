...
#| echo: TRUE
#| message: FALSE
toothGrowth<-read_csv("data/growthRates.csv") %>%
...
#| echo: TRUE
#| message: FALSE
Ex1<-read_csv("outputs/simZebraDataEX12.csv") %>% pivot_longer(cols=d18O_1:d18O_4,names_to="Amplitude",values_to="d18O",names_prefix="d18O_")
...
```{r}
Ex3<-read_csv("outputs/simZebraDataEX3.csv") %>% pivot_longer(cols=d18O_1:d18O_4,names_to="Amplitude",values_to="d18O",names_prefix="d18O_")
...
Ex4<-read_csv("outputs/simZebraDataEX4.csv") 
